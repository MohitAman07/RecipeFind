...
public class TC062_VerifyRecipeStatusChangeToRejectedNotification
        extends BaseTest {
    ...
    @Test
    public void verifyRecipeStatusChangeToRejectedNotification()
            throws Exception {
        ...
        ValidationUtil.verifyTrue(
                controlPanel.isRecipeDisplayed(
                        recipeName),
                "Recipe is  displayed in Rejected tab.");
        ...
        for (int attempt = 1;
            ...
            System.out.println(
                    "Recipe status changed from Submitted to Rejected.");
