...
public class TC032_VerifyEditGroupDescription extends BaseTest {
    ...
    @Test
    public void verifyEditGroupDescription()
            throws Exception {
         ...
         */
        ValidationUtil.verifyEquals(
                groupManagement.getGroupDescription(),
                updatedGroupDescription,
                "Group Description updated successfully.");

        System.out.println(
                "TC032_VerifyEditGroupDescription executed successfully.");
    }
}