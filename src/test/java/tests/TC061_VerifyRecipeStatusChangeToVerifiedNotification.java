...
public class TC061_VerifyRecipeStatusChangeToVerifiedNotification
        extends BaseTest {
    ...
    @Test
    public void verifyRecipeStatusChangeToVerifiedNotification()
            throws Exception {
        ...
        ValidationUtil.verifyTrue(
                controlPanel.isRecipeDisplayed(
                        recipeName),
                "Recipe is  displayed in Verified tab.");
        ...
        for (int attempt = 1;
            ...
            System.out.println(
                    "Recipe status changed from Submitted to Verified.");
