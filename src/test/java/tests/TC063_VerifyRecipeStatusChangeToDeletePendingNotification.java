...
public class TC063_VerifyRecipeStatusChangeToDeletePendingNotification
        extends BaseTest {
    ...
    @Test
    public void verifyRecipeStatusChangeToDeletePendingNotification()
            throws Exception {
        ...
        ValidationUtil.verifyTrue(
                controlPanel.isRecipeDisplayed(
                        recipeName),
                "Recipe is  displayed in Delete Pending tab.");
        ...
        for (int attempt = 1;
            ...
            System.out.println(
                    "Recipe status changed from Submitted to Delete Pending.");
